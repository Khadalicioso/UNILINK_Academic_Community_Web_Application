document.addEventListener("DOMContentLoaded", function () {
  ...
  replyToReplyButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      let replyForm = document.getElementById(
        "reply-to-reply-form-" + parentId
      );
      if (!replyForm) {
      ...
      replyInput.value =
        ...
        " " +
        "Replying to: " +
        document.querySelector(`#reply-${parentId} .reply-text`).textContent;
  ...
  showMoreReplyButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      const hiddenReplies = repliesContainer.querySelectorAll(
      ...
      const viewLessButton =
        repliesContainer.querySelector(".view-less-replies");
  ...
  viewLessReplyButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      const showMoreButton =
        repliesContainer.querySelector(".show-more-replies");
