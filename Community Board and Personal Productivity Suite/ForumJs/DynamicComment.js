...
document.querySelectorAll(".reply-form").forEach((form) => {
  form.addEventListener("submit", function (e) {
    ...
    submitButton.innerHTML =
      '<i class="fa-solid fa-spinner fa-spin"></i> Posting...'; // Optional loading feedback
      ...
      .then((data) => {
        ...
        if (data.status === "success") {
          ...
          if (repliesContainer) {
            ...
            console.error(
              "Replies container not found for comment id:",
              commentId
            );
          }
...
window.addEventListener("load", function () {
  ...
  if (
    window.location.search.includes("commentPosted=true") ||
    window.location.search.includes("replyPosted=true")
  ) {
